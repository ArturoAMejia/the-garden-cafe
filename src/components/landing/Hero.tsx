      ...
      <div className="mx-auto max-w-screen-xl bg-[#FFF9EA] px-4 pt-5 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
          <div className="lg:py-44">
            <h1 className="text-center text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl">
              The Garden Cafe
            </h1>

            <p className="mx-auto mt-3 max-w-md text-center text-lg text-gray-500 sm:text-xl md:mt-5 md:max-w-3xl">
            ...
            <div className="mt-6 sm:flex sm:justify-center lg:justify-start">
              ...
              <Link
                className="mb-4 inline-flex w-full items-center justify-center gap-2 whitespace-nowrap rounded-full border border-transparent bg-[#388C04] px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-[#8CA862]"
                href="/reservaciones"
              >
