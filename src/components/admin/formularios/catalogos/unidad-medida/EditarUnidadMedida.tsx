...
export const EditarUnidadMedida: FC<Props> = ({ unidad_medida }) => {
                      ...
                      <div className="mt-2">
                        ...
                        <div className="mt-1">
                          <input
                            ...
                            defaultValue={unidad_medida.nombre}
                          />
                        </div>
                      </div>
                      {/* Siglas */}
                      <div className="mt-2">
                        ...
                        <div className="mt-1">
                          <input
                            ...
                            {...register("siglas")}
                            className="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                            defaultValue={unidad_medida.siglas}
                          />
                        </div>
                      </div>
                      {/* Estado */}
                        ...
                        <div className="mt-1">
                          ...
                          >
                            <option
                              ...
                              value={unidad_medida.cat_estado?.id}
                            >
                              {unidad_medida.cat_estado?.nombre}
                            </option>
                          </select>
                        </div>
                      </div>
