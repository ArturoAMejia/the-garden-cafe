...
type FormData = {
  ...
  probabilidad_nivel_servicio: number;
  id_producto: number;
};

export const CrearStockSeguridad = () => {
  const { register, handleSubmit, reset } = useForm<FormData>();

  const { data: productos, isLoading } = useObtenerProductosQuery();

  const [crearStockSeguridad] = useCrearStockSeguridadMutation();
                      ...
                      <div className="mt-2">
                        ...
                        <div className="mt-1">
                          <input
                            ...
                            step="any"
                            id="stock_max"
                            {...register("probabilidad_nivel_servicio", {
                              valueAsNumber: true,
                            })}
                            className="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                          />
