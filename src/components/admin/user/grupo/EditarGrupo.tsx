...
export const EditarGrupo: FC<Props> = ({ grupo }) => {
  ...
  const { actualizarGrupo } = useContext(AdminContext);
  ...
  const onActualizarCategoria = async ({
    ...
    const { hasError, message } = await actualizarGrupo(
      id,
      nombre,
      descripcion
    );
                      ...
                      <div className="mt-2">
                        ...
                        <div className="mt-1">
                          ...
                          >
                            <option
                              key={grupo.id}
                              value={grupo.cat_estado?.nombre}
                            >
                              {grupo.cat_estado?.nombre}
                            </option>
                          </select>
                        </div>
                      </div>
